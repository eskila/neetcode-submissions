class Solution:
    def trap(self, height: List[int]) -> int:
        ...
        When the left bar is lower than the right,
        the water at the left pointer is
        determined entirely by max_l because there is guaranteed to be
        a right boundary at least as high as height[l]. This also holds
        for the symmetrical case on the right.
